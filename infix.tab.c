...
static const yytype_int8 yytranslate[] =
{
      ...
      15,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       ...
       6,     7,    10,     8,     2,     9,     2,    11,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     5,     2,    14,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
#line 76 "infix.y"
							...
							sprintf((yyval.nPointer)->var.name, "tmp%d", *temp_counter);
...
#line 124 "infix.y"
							...
							char exp[1000];
							sprintf(exp,"if(%s){\n",(yyvsp[-2].nPointer)->var.name);

							while(s->tail != (yyvsp[-2].nPointer)){
							...
							*temp_counter = *temp_counter + 1;
							...
							char expEnd[1000];
							sprintf(expEnd,"\t%s=%s;\n} else {\n\t%s=0;\n}\n", (yyval.nPointer)->var.name,(yyvsp[0].nPointer)->var.name, (yyval.nPointer)->var.name);
							strcat(exp,expEnd);
